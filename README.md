...
The console was developed in Ubuntu 20.04LTS using python

### Further information :bookmark_tabs:
For further information on python version, and documentation visit [python.org](https://www.python.org/).

## Requirements :memo:
Knowledge in python, how to use a command line interpreter, a computer with Ubuntu 20.04, python and pep8 style corrector.
